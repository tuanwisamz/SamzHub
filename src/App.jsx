...
const sectionsData = [
  {
    ...
    items: [
      ...
      { name: 'Google Scholar', url: 'https://scholar.google.com/', isFeatured: true },
  ...
  },
  {
    ...
    items: [
      { name: 'WhatsApp Web', url: 'https://web.whatsapp.com/', isFeatured: true },
      { name: 'Telegram Web', url: 'https://web.telegram.org/', isFeatured: true },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Qwen', url: 'https://qwen.aliyun.com/', isFeatured: true },
